...
<head>
    ...
    <title>Trang chủ | Thiết bị điện</title>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +89832128289</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> dat87612@st.vimaru.edu.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="wishlish.html"><i class="fa regular fa-heart"></i>Bảo hành</a></li>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="product-details.html">Giới thiệu chung</a></li> 
                                        <li><a href="checkout.html">Tầm nhìn</a></li> 
                                        <li><a href="cart.html">Hoạt động xã hội</a></li> 
                                        <li><a href="login.html">Chứng nhận và giải thưởng</a></li> 
                                    </ul>
                                </li> 
                                <li class="dropdown"><a href="#">Sản phẩm<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="blog.html">Thiết bị chiếu sáng</a></li>
                                        <li><a href="blog-single.html">Thiết bị điện</a></li>
                                    </ul>
                                </li> 
                                <li class="dropdown"><a href="#">Hãng thiết bị<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>Shop</span>-Thiết bị điện</h1>
                            ...
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>E</span>-Thiết bị chiếu sáng</h1>
                            ...
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>E</span>-Giải pháp chiếu sáng</h1>
